...
public class PasswordHandler
{
     ...
     */
    public static byte[] getPassword(String password_string)
    {
    	String[] params = password_string.split(":");
        byte[] salt = fromHex(params[PBKDF2_INDEX]);
        return salt;
    }
     ...
     */
    public static int getIterateTime(String password_string)
    {
    	String[] params = password_string.split(":");
        int iterate = Integer.parseInt(params[ITERATION_INDEX]);
        return iterate;
    }
    /**
    ...
    public static String createHash(char[] password)
    {
    	try
    	{
    		// Typical cellar to generate a random salt
